...
class ColourButton(ppu: Float) : CharacterPartButton(ppu) {
    ...
    override fun addComponents() {
        super.addComponents()
        components.add(ColouredSpriteComponent(this, icon, ppu, Vec4(colour, 1f), buttonShader, VertexShape.cornerSquareShape){
